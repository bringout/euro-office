...
patch(AttachmentList.prototype, {
  ...
  async openOnlyoffice(attachment) {
    const demo = JSON.parse(await this.orm.call("eurooffice.odoo", "get_demo"))
    ...
    const { same_tab } = JSON.parse(await this.orm.call("eurooffice.odoo", "get_same_tab"))
    if (same_tab) {
      const action = {
    ...
    window.open(`/eurooffice/editor/${attachment.id}${accessTokenQuery}`, "_blank")
  },
})
